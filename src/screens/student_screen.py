...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g. Kiran Chauhan')

            st.subheader('Optional : Voice Enrollment')
            st.info("Register your voice to enable voice-only attendance")

            audio_data = None
            try:
                audio_data = st.audio_input('Record a short phrase like I am present, My name is Kiran.')
            except Exception:
